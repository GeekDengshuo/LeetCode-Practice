...
public class BricksFallingWhenHit_803 {
    ...
    public int[] hitBricks(int[][] grids,int[][] hits){
        this.rows = grids.length;
        this.cols = grids[0].length;

        // new a copy grids
        int[][] copy_ = new int[rows][cols];
        ...
        for (int i = hitsLen - 1; i >= 0; i--) {
            ...
            for (int[] direction : DIRECTIONS) {
                ...
                if (inArea(newX, newY) && copy_[newX][newY] == 1) {
